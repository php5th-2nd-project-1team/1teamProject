...
<div class="manager-create-container">
    <div class="manager-create-section">
        <form id="managersForm" onsubmit="return handleSubmit(event)">
            <div id="managerForms">
                <!-- 초기 폼 -->
                <div class="manager-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="managers[0][account]" placeholder="이메일을 입력하세요" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">비밀번호</label>
                        <input type="password" class="form-control" name="managers[0][password]" placeholder="비밀번호를 입력하세요" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">닉네임</label>
                        <input type="text" class="form-control" name="managers[0][nickname]" placeholder="닉네임을 입력하세요" required>
                    </div>
                </div>
            </div>
    ...
    function addManagerForm() {
        const template = `
            <div class="manager-form">
                ...
                <div class="form-group">
                    <label class="form-label">계정</label>
                    <input type="email" class="form-control" name="managers[${formCount}][account]" placeholder="이메일을 입력하세요" required>
                </div>
                <div class="form-group">
                    <label class="form-label">비밀번호</label>
                    <input type="password" class="form-control" name="managers[${formCount}][password]" placeholder="비밀번호를 입력하세요" required>
                </div>
                <div class="form-group">
                    <label class="form-label">닉네임</label>
                    <input type="text" class="form-control" name="managers[${formCount}][nickname]" placeholder="닉네임을 입력하세요" required>
                </div>
            </div>
        `;
