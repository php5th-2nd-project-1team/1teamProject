...
<div class="dashboard-container">
    ...
    <div class="table-section">
        <div class="table-header">
            <div class="table-title-section">
                <h3>유저 관리</h3>
                <p class="table-description">최신 가입 유저 5명</p>
            </div>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr class="clickable-row" data-href="/manager/users/1">
                        <td>1</td>
                        <td>user123</td>
                        <td>홍길동</td>
                        <td>길동이</td>
                    ...
                    <tr class="clickable-row" data-href="/manager/users/2">
                        <td>2</td>
                        <td>kim456</td>
                        <td>김철수</td>
                        <td>철수철수</td>
    ...
    <div class="table-section">
        <div class="table-header">
            <div class="table-title-section">
                <h3>포스트</h3>
                <p class="table-description">최신 댓글 갱신 기준 5개</p>
            </div>
            <a href="#" class="detail-link">해당 상세 페이지로 →</a>
        </div>
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <tbody>
                    <tr class="clickable-row" data-href="/manager/posts/1">
                        <td>1</td>
                        <td>맛집 추천</td>
                        <td>서울</td>
                        <td>15</td>
                    ...
                    <tr class="clickable-row" data-href="/manager/posts/2">
                        <td>2</td>
                        <td>여행 후기</td>
                        <td>부산</td>
                        <td>23</td>
